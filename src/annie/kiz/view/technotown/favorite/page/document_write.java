...
public class document_write extends SherlockActivity implements AdViewListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			if(MainActivity.subject != null & MainActivity.num != null){
				content_edittext.setText(MainActivity.num+"  " + MainActivity.subject);
			}
...
//				profile.setImageBitmap(profile_bitmap); // ?�진 ?�택???�진URI�??�결?�기
//				// Profile changed
file_kind = 1;
				attach_exist = true;
